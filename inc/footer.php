  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4">
        ...
        Telefono: 0800-123-9876<br>
        E-mail: <a href="#">lstore@linuxstore.com.ar</a>
        </p>
      </div>
      <div class="col-sm-4">
        <h4 class="text-info">Suscríbete</h4>
        <p class="text-warning">Suscríbete para recibir ofertas y noticias de nuestros productos</p>
    ...
    <h4 class="text-center" style="color: #E3DAC9;">Héctor Fabián Alvarez ©2021 | Curso PHP Fullstack CAC</h4>
  </div>
</footer>