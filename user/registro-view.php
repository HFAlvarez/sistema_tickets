<?php
    if(isset($_POST['user_reg']) && isset($_POST['clave_reg']) && isset($_POST['nom_complete_reg'])){
        ...
        $mensaje_mail="Hola ".$nombre_reg.", gracias por registrarte en LinuxStore Argentina. Los datos de cuenta son los siguientes:\nNombre Completo: ".$nombre_reg."\nNombre de usuario: ".$user_reg."\nClave: ".$clave_reg2."\nEmail: ".$email_reg."\n Página principal: http://www.linuxstore.com.ar/index.php";
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-4 text-center hidden-xs">
      ...
      <h2 class="text-primary">¡Gracias por elegirnos!</h2>
    </div>
