<div class="container">
  <div class="row well">
    ...
    <div class="col-sm-9 lead">
      ...
      <p>Si tienes problemas con alguno de nuestros productos nos puedes enviar un nuevo ticket, nosotros lo respondemos y solucionaremos tu problema.<br>Si ya nos enviaste un ticket puedes consultar su estado mediante su <strong>Ticket ID</strong>.</p>
    </div>
  </div><!--fin row 1-->
    ...
    <div class="col-sm-6">
      <div class="panel panel-info">
        ...
        <div class="panel-body text-center">
          ...
          <p class="text-justify">Si tienes un problema con cualquiera de nuestros productos, avísanos creando un nuevo ticket y te ayudaremos a solucionarlo. Si deseas actualizar una petición ya realizada utiliza el formulario de la derecha <em>Comprobar estado de Ticket</em>, solamente los <strong>usuarios registrados</strong> pueden abrir un nuevo ticket.</p>
