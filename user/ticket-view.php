<?php if(isset($_SESSION['nombre']) && isset($_SESSION['tipo'])){
        ...
        if(isset($_POST['fecha_ticket']) && isset($_POST['name_ticket']) && isset($_POST['email_ticket'])){
          ...
          $cabecera="From: LinuxStore Argentina<linuxstore.arg@gmail.com>";
          $mensaje_mail="¡Gracias por registrar tu problema! Buscaremos una solución para tu producto lo más pronto posible. Su ID ticket es: ".$id_ticket;
        ...
        <div class="container">
          <div class="row well">
            ...
            <div class="col-sm-9 lead">
              ...
              <p>Para abrir un nuevo ticket deberás llenar todos los campos del siguiente formulario. Podrás verificar el estado de tu ticket mediante el <strong>Ticket ID</strong> que te proporcionará el sistema cuando llenes y envíes el formulario.</p>
            </div>
          </div><!--fin row 1-->
                ...
                <div class="panel-body">
                  <div class="row">
                    <div class="col-sm-4 text-center">
                      ...
                      <p class="text-primary text-justify">Por favor llena todos los datos de este formulario para abrir tu ticket. El <strong>Ticket ID</strong> será enviado a la dirección de correo electronico proporcionada en este formulario.</p>
                    </div>
                    <div class="col-sm-8">
                      <form class="form-horizontal" role="form" action="" method="POST">
                        ...
                        <div class="form-group">
                          <label  class="col-sm-2 control-label">Problema de tu producto</label>
                          <div class="col-sm-10">
