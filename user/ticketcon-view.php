...
?>
        <div class="container">
            ...
            <div class="col-sm-10 lead text-justify">
              ...
              <p>Si tu <strong>ticket</strong> no ha sido solucionado aún, ten paciencia, estamos trabajando para poder resolver tu problema y darte una solución.</p>
            </div>
          </div><!--fin row well-->
          <div class="row">
              <div class="col-sm-12">
        ...
        <div class="container">
            <div class="row  animated fadeInDownBig">
                ...
                <div class="col-sm-7 text-center">
                    ...
                    <br>
                    <h3 class="text-primary"> Por favor verifica que tu <strong>id ticket</strong> y <strong>email</strong> sean correctos, e intenta nuevamente.</h3>
